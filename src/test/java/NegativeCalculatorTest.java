...
public class NegativeCalculatorTest {
    ...
    public void negativeTest(String op, String n1, String n2) throws IllegalAccessException {
        if (op.isEmpty()|| (op == null) || n1.isEmpty()||(n1== null) ||n2.isEmpty()||(n2== null)){ throw new CalculatorException("Ввод не должен быть пустым");}
        else {
